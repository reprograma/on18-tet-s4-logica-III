...
function filtrarFilmesTitulo(titulo) {
  for (let filme of filmes) {
    let buscaTitulo = filmes.find((filme) =>
      filme.titulo.toUpperCase().includes(titulo.toUpperCase())); {
...
function filtrarFilmesGenero(genero) {
  for (let filme of filmes) {
    let buscaGenero = filmes.filter((filme) =>
      filme.genero.includes(genero.toUpperCase()) ||
      filme.genero[0].toUpperCase().includes(genero.toUpperCase())) ||
      filme.genero[1].toUpperCase().includes(generi.toUpperCase()); {
